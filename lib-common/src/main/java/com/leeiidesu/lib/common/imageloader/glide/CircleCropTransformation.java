...
public class CircleCropTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.leeiidesu.lib.common.a.glide.CircleCropTransformation." + VERSION;
    ...
    public CircleCropTransformation(int strokeWidth, @ColorInt int strokeColor) {
        // Intentionally empty.
