package cn.leeii.simple.pager.fragments;
...
public abstract class ExpandingFragment extends Fragment {
    ...
    protected abstract boolean isCurrentShowFragment();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        if (isMove && isOpenend() && event.getY() - startY > 100) {
                            close();
                            isMove = false;
                            return true;
                        } else if (isMove && !isOpenend() && event.getY() - startY < -100) {
                            open();
                            isMove = false;
                            return true;
                        }
    ...
    public void open() {
        ...
        frontAnimator.addListener(new Animator.AnimatorListener() {
            @Override
