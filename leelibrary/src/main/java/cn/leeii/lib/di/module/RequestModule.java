...
import cn.leeii.lib.tool.LogInterceptor;
import cn.leeii.lib.tool.converter.FsonConverterFactory;
...
public class RequestModule {
     ...
     * 配置okHttpclient
     */
    private OkHttpClient configureClient(OkHttpClient.Builder okHttpClient, Interceptor intercept, Cache cache) {
